...
<head>
  ...
  <style>
    ...
    .drink-option{background:linear-gradient(180deg,#121b42,#0d1433);border:1px solid #22306b}
    .drink-option:hover{transform:translateY(-2px);background:linear-gradient(180deg,#152254,#10183e)}
  </style>
</head>
