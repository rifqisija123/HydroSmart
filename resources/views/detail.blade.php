...
<body class="min-h-screen bg-bg flex flex-col">
    ...
    <header class="sticky top-0 z-40 backdrop-blur bg-[#0b1026e6] border-b border-border">
        <div class="max-w-5xl mx-auto px-5 py-4 flex items-center justify-between">
            ...
            <a href="{{ route('volume', ['drink' => $drink]) }}"
                class="pill inline-flex items-center gap-2 rounded-full px-3 py-2 text-xs">← Kembali</a>
        </div>
    </header>
            ...
            <div class="grid md:grid-cols-2 gap-6">
                <div>
                    ...
                    <div class="mt-5 flex flex-wrap gap-3">
                        ...
                        <button id="btnUbahPilihan" class="pill rounded-xl px-4 py-3">Ubah Pilihan</button>
                    </div>
                ...
                <div class="grid place-items-center">
                    <svg viewBox="0 0 240 260" width="230" height="260" aria-hidden="true">
                        ...
                        <rect x="10" y="10" width="220" height="240" rx="18" fill="url(#glow)"
                            opacity="0.25" />

                        <rect x="20" y="20" width="200" height="45" rx="8" fill="#0f1c3d" stroke="#3b6dd6"
                            stroke-opacity="0.6" />

                        <text x="120" y="48" text-anchor="middle" fill="#cfe3ff" font-size="12" font-weight="600">
                            Simulasi Dispenser
                        </text>

                        <rect x="30" y="75" width="180" height="140" rx="12" fill="#ffffff08"
                            stroke="#395fb0" stroke-opacity="0.4" />

                        <rect x="30" y="200" width="180" height="20" rx="6" fill="#1b2d55"
                            stroke="#508cff" stroke-width="1.2" />

                        <rect x="105" y="130" width="40" height="50" rx="6" fill="#b8dcff22"
                            stroke="#65b6ff" />

                        <rect x="105" y="130" width="12" height="50" rx="6" fill="url(#cupShine)" />

                        <rect x="135" y="95" width="4" height="20" fill="#66c8ff" />

                        <circle cx="137" cy="122" r="4" fill="#00d4ff" opacity="0.8">
                            <animate attributeName="cy" from="122" to="140" dur="0.9s"
                                repeatCount="indefinite" />
                            <animate attributeName="opacity" from="0.9" to="0" dur="0.9s"
                                repeatCount="indefinite" />
                        </circle>
            ...
            try {
                ...
                window.snap.pay(token, {
                    ...
                    onPending: function(result) {
                        ...
                        showErr(
                            'Pembayaran masih menunggu, silakan selesaikan di aplikasi pembayaran Anda.'
                        );
                    },
    ...
    {{-- Modal Ubah Pilihan --}}
    <div id="modalUbah" class="fixed inset-0 z-50 hidden items-center justify-center"
        style="background:rgba(0,0,0,0.6); backdrop-filter:blur(4px);">
        <div class="cardish border border-border rounded-2xl p-6 w-[90%] max-w-md mx-auto"
            style="animation: modalIn 0.25s ease-out;">
            <div class="text-center mb-5">
                <div class="text-lg font-bold">Ubah Pilihan</div>
                <p class="text-[#a8b3ff] text-sm mt-1">Apa yang ingin Anda ubah?</p>
            </div>

            <div class="flex flex-col gap-3">
                {{-- Ubah Minuman --}}
                <a href="{{ route('home') }}"
                    class="flex items-center gap-4 rounded-xl p-4 border border-border
                  bg-gradient-to-r from-[#121b42] to-[#0d1433]
                  hover:from-[#152254] hover:to-[#10183e]
                  transition-all duration-200 hover:-translate-y-[1px]">
                    <div class="w-10 h-10 rounded-lg bg-[#4aa3ff22] flex items-center justify-center text-xl shrink-0">
                        ☕</div>
                    <div>
                        <div class="font-semibold">Ubah Minuman</div>
                        <div class="text-[#a8b3ff] text-xs mt-0.5">Kembali ke halaman pilih minuman</div>
                    </div>
                    <span class="ml-auto text-[#a8b3ff]">→</span>
                </a>
                ...
                <a href="{{ route('volume', ['drink' => $drink]) }}"
                  ...
                  hover:from-[#152254] hover:to-[#10183e]
                  transition-all duration-200 hover:-translate-y-[1px]">
                    <div class="w-10 h-10 rounded-lg bg-[#00d4ff22] flex items-center justify-center text-xl shrink-0">
                        💧</div>
                    <div>
                        <div class="font-semibold">Ubah Volume</div>
                        <div class="text-[#a8b3ff] text-xs mt-0.5">Kembali ke halaman pilih volume</div>
                    </div>
                    <span class="ml-auto text-[#a8b3ff]">→</span>
                </a>
            </div>

            <button id="btnCloseModal" class="mt-4 w-full text-center pill rounded-xl px-4 py-2.5 text-sm">
                Batal
            </button>
        </div>
    </div>
    ...
    <script>
        ...
        document.getElementById('btnUbahPilihan').addEventListener('click', () => {
