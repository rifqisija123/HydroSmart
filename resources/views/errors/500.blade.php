...
<head>
    ...
    <title>WADAH — Terjadi Kesalahan</title>
    ...
    <main class="flex-1 flex items-center justify-center px-5 py-12">
        <div class="cardish border border-border rounded-2xl p-8 md:p-12 max-w-lg w-full text-center">
            ...
            <div class="flex justify-center mb-6" style="animation: float 3s ease-in-out infinite;">
                <div
                    class="w-28 h-28 rounded-full bg-[#ffaa4a12] border border-[#ffaa4a33] flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-14 h-14 text-[#ffaa6b]" fill="none"
            ...
            <div class="text-6xl font-extrabold text-[#ffaa6b] tracking-tight">500</div>
            <h1 class="text-xl font-bold mt-3">Terjadi Kesalahan Server</h1>
