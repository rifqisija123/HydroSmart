...
<head>
    ...
    <title>WADAH — Halaman Tidak Ditemukan</title>
    ...
    <main class="flex-1 flex items-center justify-center px-5 py-12">
        <div class="cardish border border-border rounded-2xl p-8 md:p-12 max-w-lg w-full text-center">
            ...
            <div class="flex justify-center mb-6" style="animation: float 3s ease-in-out infinite;">
                <div
                    class="w-28 h-28 rounded-full bg-[#4aa3ff12] border border-[#4aa3ff33] flex items-center justify-center">
            ...
            <div class="text-6xl font-extrabold text-primary tracking-tight">404</div>
            <h1 class="text-xl font-bold mt-3">Halaman Tidak Ditemukan</h1>
