...
<head>
  ...
  <style>
    ...
    @keyframes popPulseRed {
      0%   { transform: scale(0.6); opacity: 0; filter: drop-shadow(0 0 0 rgba(239,68,68,0)); }
      10%  { transform: scale(1.15); opacity: 1; filter: drop-shadow(0 8px 24px rgba(239,68,68,.45)); }
      18%  { transform: scale(1.0);  opacity: 1; }
      70%  { transform: scale(1.0);  opacity: 1; }
      100% { transform: scale(0.98); opacity: 1; filter: drop-shadow(0 4px 12px rgba(239,68,68,.25)); }
    }
    .animate-pop-red-3s {
...
<body class="min-h-screen flex flex-col bg-bg">
  ...
  <main class="flex-grow w-full mx-auto px-6 py-12 max-w-lg md:max-w-xl">
    <div class="cardish border border-border rounded-2xl p-8 text-center">
      ...
      {{-- Icon X merah --}}
      <div class="mx-auto w-16 h-16 rounded-full bg-danger flex items-center justify-center mb-4 animate-pop-red-3s">
